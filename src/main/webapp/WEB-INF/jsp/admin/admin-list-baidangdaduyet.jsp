...
<c:url var="baiDangURL" value="/admin-quanlybaidang/showbaidangdaduyet" />
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Quản lý bài đăng đã duyệt</li>
                </ul>

                <div class="nav-search" id="nav-search">
                    <form action="/admin-quanlybaidang/showbaidangdaduyet" class="form-search" id="formSearch" method="get">
