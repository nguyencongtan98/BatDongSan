...
<c:url var="creThoiHan" value="/admin/addloaitin"/>
<c:url var="addNewList" value="/admin-quanlyloaitin/showloaitin"/>
<c:url var="addThoiHanList" value="/admin-quanlyloaitin/themloaitin"/>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            ...
            <div class="page-content">
                ...
                <form action="/admin-quanlyloaitin/themloaitin" id="formSubmit">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label for="tenLoaiTin" class="col-sm-3 control-label no-padding-right"> Tên loại tin </label>
                                        <div class="col-sm-9">
                                            <input style="width: 300px" type="text" id="tenLoaiTin" name="tenLoaiTin"
                                                   value="" placeholder="Nhập tên loại tin" required/>
                                        </div>
                                    </div>
                                    <br/>
                                    <br/>
                ...
                $.ajax({
                    ...
                    success: function addLoaiTin(result) {
                        if(result.id==0) {
                            ...
                            $('#showerror').html('Thêm loại tin thành công !');
                        }
                    }
                });
            }
