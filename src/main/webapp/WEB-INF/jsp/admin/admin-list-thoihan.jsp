...
<c:url var="deleteThoiHan" value="/admin/xoathoihan"/>
<c:url var="deleteURL" value="/admin-quanlythoihan/showthoihan"/>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta charset="utf-8"/>
    <title>Quản lý thời hạn</title>
    ...
    <script type="text/javascript">
        $(function () {
            var pageSize = 3; // Hiển thị số sản phẩm trên 1 trang
                                ...
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <a flag="info"
                                           ...
                                           data-toggle="tooltip"
                                           title='Thêm thời hạn' href='/admin-quanlythoihan/themthoihan'>
                                            <span>
                            ...
                            <div class="col-xs-12">
                                <div class="table-responsive">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                        <c:forEach var="item" items="${listThoiHan}">
                                            <tr class="contentPage">
                                                ...
                                                <td><a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       ...
                                                       href="/admin-quanlythoihan/editthoihan/${item.id}">
