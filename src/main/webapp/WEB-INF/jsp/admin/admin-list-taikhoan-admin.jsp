...
<c:url var="deleteTaiKhoanAdmin" value="/admin/xoataikhoanadmin"/>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <div class="nav-search" id="nav-search">
                        <form action="/admin-quanlytaikhoan/showtaikhoanadmin" class="form-search" id="formSearch" method="get">
                                ...
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <%--<a flag="info"
                                           ...
                                           data-toggle="tooltip"
                                           title='Thêm danh mục' href='/quanlydanhmuc/themdanhmuc'>
                                            <span>
