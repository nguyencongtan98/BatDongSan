...
<c:url var="addThoiHanList" value="/admin-quanlythoihan/themthoihan"/>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"/>
    <meta charset="utf-8"/>
    <title>Thêm thời hạn</title>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="number" min="1" cssClass="form-control" id="soNgay"
                                                   name="soNgay"
                                                   value="" placeholder="Nhập số ngày" required/>
                                        </div>
                                    </div>
                                    <div class="row">
            ...
            function addThoiHan(data) {
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.id == 0) {
                            $('#showerror').html("Thời hạn đã tồn tại !");
                        } else {
                            $('#showerror').html("Thêm thời hạn thành công !");
                        }
                    },
                    error: function (error) {
                        window.location.href = "${addThoiHanList}?message=insert_failed";
                    }
                });
            }
        </script>
