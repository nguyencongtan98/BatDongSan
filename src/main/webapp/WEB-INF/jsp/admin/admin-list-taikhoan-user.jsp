...
<c:url var="deleteUser" value="/admin/xoataikhoanuser"/>
<c:url var="deleteURL" value="/admin-quanlytaikhoan/showtaikhoanuser"/>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <div class="nav-search" id="nav-search">
                        <form action="/admin-quanlytaikhoan/showtaikhoanuser" class="form-search" id="formSearch" method="get">
                                        ...
                                        <c:forEach var="item" items="${listTaiKhoan}">
                                            <tr class="contentPage">
                                                ...
                                                <td><a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Xem thông tin"
                                                       href="/admin-quanlytaikhoan/chitiettaikhoan?id=${item.id}">
...
<script>
    $('#btnDelete').click(function (e) {
        ...
        if (ids == '') {
            $('#showerror').text('Hãy chọn tài khoản cần xóa !');
            alert("Bạn chưa chọn tài khoản cần xóa !");
            return false;
        } else {
            swal({
                title: "Xác nhận xóa",
