document.createElement("canvas").getContext || !function () {
    ...
    function x(a, b, c, d) {
        ...
        if (e instanceof B) {
            ...
            if ("gradient" == e.type_) {
                var n = e.x0_ / f, o = e.y0_ / g, q = e.x1_ / f, r = e.y1_ / g, s = y(a, n, o), t = y(a, q, r),
                    u = t.x - s.x, v = t.y - s.y;
    ...
    var G = Math, H = G.round, I = G.sin, J = G.cos, K = G.abs, L = G.sqrt, M = 10, N = M / 2,
    ...
    var T = {
            ...
            whitesmoke: "#F5F5F5",
            yellowgreen: "#9ACD32"
        }, U = {}, V = {style: "normal", variant: "normal", weight: "normal", size: 10, family: "sans-serif"}, W = {},
        X = {butt: "flat", round: "round"}, Y = u.prototype;
    Y.clearRect = function () {
        ...
        var e = y(this, a, b), f = y(this, c, d), g = {
        ...
        var m = a.width, n = a.height;
        if (a.runtimeStyle.width = k, a.runtimeStyle.height = l, 3 == arguments.length) c = arguments[1], d = arguments[2], g = h = 0, i = e = m, j = f = n; else if (5 == arguments.length) c = arguments[1], d = arguments[2], e = arguments[3], f = arguments[4], g = h = 0, i = m, j = n; else {
        ...
        if (p.push(" <g_vml_:group", ' coordsize="', M * q, ",", M * r, '"', ' coordorigin="0,0"', ' style="width:', q, "px;height:", r, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
            ...
            var t = o, u = y(this, c + e, d), v = y(this, c, d + f), w = y(this, c + e, d + f);
        ...
        var b = J(a), c = I(a), d = [[b, c, 0], [-c, b, 0], [0, 0, 1]];
        ...
        var g = this.m_, h = 1e3, i = 0, j = h, k = {x: 0, y: 0}, l = [], m = r(q(this.font), this.element_), n = s(m),
            o = this.element_.currentStyle, p = this.textAlign.toLowerCase();
        switch (p) {
            case"left":
            case"center":
            case"right":
