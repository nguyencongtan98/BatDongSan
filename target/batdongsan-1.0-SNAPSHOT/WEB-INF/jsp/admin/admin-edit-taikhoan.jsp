...
<c:url var="lockTaiKhoan" value="/admin/khoataikhoan"/>
<c:url var="lockTaiKhoanAdmin" value="/admin/khoataikhoanadmin"/>
<c:url var="unlockTaiKhoan" value="/admin/motaikhoan"/>
<c:url var="unlockTaiKhoanSuccess" value="/admin-quanlytaikhoan/showtaikhoanlockuser"/>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    <c:if test="${listTaiKhoan.status == 1 && listTaiKhoan.trangThai == 1}">
                        <li>
                            ...
                            <a href="/admin-quanlytaikhoan/showtaikhoanuser">Quản lý</a>
                        </li>
                    </c:if>
                    <c:if test="${listTaiKhoan.status == 1 && listTaiKhoan.trangThai == 0}">
                        <li>
                            <i class="ace-icon fa fa-home home-icon"></i>
                            <a href="/admin-quanlytaikhoan/showtaikhoanlockuser">Quản lý</a>
                        </li>
                    </c:if>
                ...
                <c:if test="${listTaiKhoan.status == 1 && listTaiKhoan.trangThai == 1}">
                    <div style="float: right">
                        <ul class="breadcrumb">
                            <li>
                                <a href="/admin-quanlytaikhoan/showtaikhoanuser">Quay lại</a>
                            </li>
                        </ul>
                    </div>
                </c:if>
                <c:if test="${listTaiKhoan.status == 1 && listTaiKhoan.trangThai == 0}">
                    <div style="float: right">
                        <ul class="breadcrumb">
                            <li>
                                <a href="/admin-quanlytaikhoan/showtaikhoanlockuser">Quay lại</a>
                            </li>
                        </ul>
                    </div>
                </c:if>
            ...
            <div class="page-content">
              ...
              <%--  <div>
                    <c:if test="${listTaiKhoan.quyenEntity.id==2}">
                        <h2 style="color: red">Thông tin người dùng</h2>
                    </c:if>
                    <c:if test="${listTaiKhoan.quyenEntity.id==1}">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input style="width: 400px" type="text" cssClass="form-control" id="hoTen" name="hoTen" value="${listTaiKhoan.hoTen}" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input style="width: 400px" type="text" cssClass="form-control" id="email" name="email" value="${listTaiKhoan.email}" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input style="width: 400px" type="text" cssClass="form-control" id="diaChi" name="diaChi" value="${listTaiKhoan.diaChi}" disabled/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input style="width: 400px" type="text" cssClass="form-control" id="soDienThoai" name="soDienThoai" value="${listTaiKhoan.soDienThoai}" disabled/>
                                    </div>
                                </div>

                               <%-- <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="quyen"> Vai trò </label>

                                    <div class="col-sm-9">
                                        <c:if test="${listTaiKhoan.quyenEntity.id == 2}">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="quyen" name="quyen" value="Người dùng" disabled/>
                                        </c:if>
                                        <c:if test="${listTaiKhoan.quyenEntity.id == 1}">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="quyen" name="quyen" value="Quản trị viên" disabled/>
                                        </c:if>
                                    </div>
                                </div>--%>

                                <div class="form-group">
                                    <label class="col-sm-3 control-label no-padding-right" for="trangThai"> Trạng thái </label>
                                    <div class="col-sm-9">
                                        <c:if test="${listTaiKhoan.trangThai == 1 && listTaiKhoan.status == 1}">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="trangThai" name="trangThai" value="Đang hoạt động" disabled/>
                                        </c:if>
                                        <c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 1}">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="trangThai" name="trangThai" value="Tạm ngưng hoạt động" disabled/>
                                        </c:if>
                                        <c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 0}">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="trangThai" name="trangThai" value="Ngưng hoạt động" disabled/>
                                        </c:if>
                                    </div>
                                </div>
                                <c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 1}">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="tinhTrang"> Tình trạng </label>
                                        <div class="col-sm-9">
                                                <input style="width: 400px" type="text" cssClass="form-control" id="tinhTrang" name="tinhTrang" value="Khóa ${listTaiKhoan.thoiHanKhoaEntity.soNgayKhoa} ngày" disabled/>
                                        </div>
                                    </div>
                                </c:if>
                                <c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 1}">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="ngayKhoa"> Ngày khóa </label>
                                        <div class="col-sm-9">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="ngayKhoa" name="ngayKhoa" value="${listTaiKhoan.ngayKhoa}" disabled/>
                                        </div>
                                    </div>
                                </c:if>
                                <c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 1}">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="nguoiKhoa"> Người khóa </label>
                                        <div class="col-sm-9">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="nguoiKhoa" name="nguoiKhoa" value="${listTaiKhoan.nguoiKhoa}" disabled/>
                                        </div>
                                    </div>
                                </c:if>
                                <c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 0}">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="tinhTrang1"> Tình trạng </label>
                                        <div class="col-sm-9">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="tinhTrang1" name="tinhTrang1" value="Đã xóa" disabled/>
                                        </div>
                                    </div>
                                </c:if>
                                <%--<c:if test="${listTaiKhoan.trangThai == 0 && listTaiKhoan.status == 0}">
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label no-padding-right" for="nguoiXoa"> Người xóa </label>
                                        <div class="col-sm-9">
                                            <input style="width: 400px" type="text" cssClass="form-control" id="nguoiXoa" name="nguoiXoa" value="${listTaiKhoan.nguoiXoa}" disabled/>
                                        </div>
                                    </div>
                                </c:if>--%>
                            </div>
            ...
            function khoaTaiKhoan(data){
                $.ajax({
                    ...
                    success : function(result){
                        window.location.href = "${addNewList1}?message=lock_success";
                    },
                    error : function (error){
                        window.location.href = "${addNewList1}?message=lock_failed";
                    }
                });
            }
