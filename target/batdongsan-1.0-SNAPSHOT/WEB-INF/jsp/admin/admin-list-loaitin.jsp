...
<c:url var="searchLoaiTin" value="/admin-quanlyloaitin/timkiemloaitin"/>
<c:url var="deleteLoaiTin" value="/admin/xoaloaitin"/>
<c:url var="deleteURL" value="/admin-quanlyloaitin/showloaitin"/>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <div class="nav-search" id="nav-search">
                    <form action="/admin-quanlyloaitin/timkiemloaitin" class="form-search" id="formSearch" method="get">
                        ...
                        <%--<button id="idSearch" type="submit">Tìm kiếm</button>--%>
                    </form>
                </div>
            </div>
                                ...
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <a flag="info"
                                           ...
                                           data-toggle="tooltip"
                                           title='Thêm loại tin' href='/admin-quanlyloaitin/themloaitin'>
                                            <span>
                                        ...
                                        <button id="btnDelete" type="button"
                                                ...
                                                data-toggle="tooltip" title='Xóa loại tin'>
                                            <span>
                                        ...
                                        <c:forEach var="item" items="${listLoaitin}">
                                            <tr class="contentPage">
                                                ...
                                                <td><a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       ...
                                                       href="/admin-quanlyloaitin/capnhatloaitin/${item.id}">
...
<%--<script>
    $('#btnSearch').submit(function (e) {
        ...
        if ($.trim(searchInput) == '') {
            $('#showerror').text('Hãy nhập loại tin cần tìm');
