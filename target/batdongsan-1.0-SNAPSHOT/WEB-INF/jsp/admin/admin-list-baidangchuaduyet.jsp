...
<c:url var="baiDangURL" value="/admin-quanlybaidang/showbaidangchuaduyet" />
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Quản lý bài đăng chưa duyệt</li>
                </ul>

                <div class="nav-search" id="nav-search">
                    <form action="/admin-quanlybaidang/showbaidangchuaduyet" class="form-search" id="formSearch" method="get">
                                        ...
                                        <c:forEach var="item" items="${listBaiDang}">
                                            <tr class="contentPage">
                                                ...
                                                <td><a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Chi tiết bài đăng" href="/admin-quanlybaidang/chitietbaidang?id=${item.id}">
